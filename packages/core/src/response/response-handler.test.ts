...
describe('ResponseHandler', () => {
  ...
  describe('handleErrorResponse', () => {
    it('should handle error responses', async () => {
      ...
      // Act
      const result = await handler.handleErrorResponse(errorResponse);
  ...
  describe('handleResourceResponse', () => {
    ...
    const createResourceResponse = (content: string, contentType: string): { 
      response: Response; 
...
describe('isText', () => {
  ...
  const createTestResponseSchema = (contentType?: string): { operation: unknown; getIsTextResult: () => boolean } => {
